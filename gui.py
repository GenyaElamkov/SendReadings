...
class Example(tk.Tk):
    ...
    def __init__(self):
        ...
        Label(self, text='Месяц:', font=('Arial', 18, 'bold')).grid(row=1, column=0,
                                                                    padx=10, pady=10)
        ...
        Label(self, text='Год:', font=('Arial', 18, 'bold')).grid(row=1,
        ...
        Label(self, text='T1:', font=('Arial', 18, 'bold')).grid(row=2,
                                                                 column=0, padx=10, pady=10,
                                                                 sticky='we')
        self.var_t1 = IntVar()
        Entry(self, textvariable=self.var_t1, font=('Arial', 18), justify='center').grid(row=2,
                                                                                         column=1,
                                                                                         padx=10,
                                                                                         pady=10,
                                                                                         columnspan=3)

        Label(self, text='T2:', font=('Arial', 18, 'bold')).grid(row=3,
                                                                 column=0, padx=10, pady=10)
        self.var_t2 = IntVar()
        Entry(self, textvariable=self.var_t2, font=('Arial', 18), justify='center').grid(row=3,
                                                                                         column=1,
                                                                                         padx=10,
                                                                                         pady=10,
                                                                                         columnspan=3)
        ...
        self.var_t3 = IntVar()
        Entry(self, textvariable=self.var_t3, font=('Arial', 18), justify='center').grid(row=4,
                                                                                         column=1,
                                                                                         padx=10,
                                                                                         pady=10,
                                                                                         columnspan=3)

        Button(self, text='Отправить', command=self.on_click, font=('Arial', 24, 'bold')).grid(row=5,
                                                                                               column=0,
                                                                                               columnspan=4,
                                                                                               padx=10, pady=5,
                                                                                               sticky='we')
    ...
    def displays_message(self, dict_data):
        label = f'''
